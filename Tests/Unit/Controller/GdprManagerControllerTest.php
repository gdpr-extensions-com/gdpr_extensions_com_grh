...
namespace GdprExtensionsCom\GdprExtensionsComGrh\Tests\Unit\Controller;
...
{
    /**
     * @var \GdprExtensionsCom\GdprExtensionsComGrh\Controller\GdprManagerController|MockObject|AccessibleObjectInterface
     */
    protected $subject;
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder($this->buildAccessibleProxy(\GdprExtensionsCom\GdprExtensionsComGrh\Controller\GdprManagerController::class))
    ...
    public function listActionFetchesAllGdprManagersFromRepositoryAndAssignsThemToView(): void
    {
        ...
        $gdprManagerRepository = $this->getMockBuilder(\GdprExtensionsCom\GdprExtensionsComGrh\Domain\Repository\GdprManagerRepository::class)
            ->onlyMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $gdprManager = new \GdprExtensionsCom\GdprExtensionsComGrh\Domain\Model\GdprManager();
